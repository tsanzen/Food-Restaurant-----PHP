...
<body>
    ...
    <div class="confirmation-modal">
        ...
        <form action="" method="POST">
            ...
            <button type="button" class="cancel-btn" onclick="window.location.href='manage-categories.php';">Cancel</button>
        </form>
    </div>
    ...
    <?php
        ...
        if (isset($_POST['confirm_delete'])) {
            ...
            if($image_name !== ""){
                ...
                if($remove == false){
                    $_SESSION['remove'] = '<div class="error" id="session"> Failed to remove category image!</div>'; 
                    header("Location: ".SITEURL.'admin/categories/manage-categories.php');
            ...
            if ($res == TRUE) {
                $_SESSION['delete'] = '<div class="success" id="session"> Category is deleted successfully</div>';
                header("Location: ".SITEURL.'admin/categories/manage-categories.php');
            }else{
                $_SESSION['delete'] = '<div class="error" id="session"> Failed to delete the category!</div>';
                header("Location: ".SITEURL.'admin/categories/manage-categories.php');
            }
        }
      ?>
